    ...
    <div className="min-h-screen bg-slate-900 text-white">
        ...
        <div className="max-w-7xl mx-auto px-4 py-3">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-6">
              <h1 className="text-xl font-bold text-blue-400">TRUYENRADIO</h1>
              <div className="relative">
                <Input
                  placeholder="Tìm kiếm tên truyện..."
                  className="w-80 bg-slate-700 border-slate-600 text-white placeholder:text-slate-400"
                />
                <Search className="absolute right-3 top-1/2 transform -translate-y-1/2 w-4 h-4 text-slate-400" />
              </div>
            </div>
            <div className="flex items-center gap-4">
              <span className="text-sm text-slate-300">Thể Loại</span>
              <span className="text-sm text-slate-300">Truyện Full</span>
              <span className="text-sm text-slate-300">Gửi Truyện</span>
      ...
      <div className="max-w-7xl mx-auto px-4 py-3">
        <div className="flex items-center gap-2 text-sm text-slate-400">
          ...
          <span>Kỳ huyễn</span>
          <ChevronRight className="w-4 h-4" />
          <span className="text-white">Ta Dũng Thần Thông Có Kỹ Thuật</span>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 pb-8">
            ...
            <div className="flex-1">
              ...
              <div className="flex items-center gap-2 mb-4">
                <div className="flex">
                  ...
                  {[4, 5].map((star) => (
                    <Star key={star} className="w-4 h-4 text-slate-500" />
                  ))}
                </div>
                <span className="text-sm text-slate-400">2.7/5 - (4 Vote)</span>
              </div>
              ...
              <div className="grid grid-cols-2 gap-4 mb-4">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-sm text-slate-400">Tác giả:</span>
                  <span className="text-sm text-blue-400">Thương Thiên Bạch Hạc</span>
                </div>
                <div className="flex items-center gap-2">
                  <Tag className="w-4 h-4 text-slate-400" />
                  <span className="text-sm text-slate-400">Thể loại:</span>
                  <span className="text-sm text-blue-400">Cổ Tử Kỳ huyễn</span>
                </div>
                <div className="flex items-center gap-2">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-sm text-green-400">Hoàn thành</span>
                </div>
                <div className="flex items-center gap-2">
                  <Eye className="w-4 h-4 text-slate-400" />
                  <span className="text-sm text-slate-400">Lượt nghe:</span>
        ...
        <Card className="bg-slate-800 border-slate-700 p-4 mb-6">
          ...
          <div className="flex items-center gap-4 mb-4">
            <span className="text-sm text-slate-400 w-12">0:00:00</span>
            <div className="flex-1 bg-slate-700 h-1 rounded-full">
              <div className="bg-blue-500 h-1 rounded-full" style={{ width: "0%" }}></div>
            </div>
            <span className="text-sm text-slate-400 w-12">5:21:09</span>
          </div>
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-4">
              <SkipBack className="w-6 h-6 text-slate-400 cursor-pointer hover:text-white" />
              ...
              <SkipForward className="w-6 h-6 text-slate-400 cursor-pointer hover:text-white" />
            </div>
            ...
            <div className="flex items-center gap-4">
              ...
              <span className="text-sm text-slate-400">0.9x</span>
            </div>
          </div>

          {/* Timer */}
          <div className="flex items-center justify-center mt-4">
            <span className="text-sm text-slate-400">00:00:00</span>
          </div>
        </Card>
        ...
        <Card className="bg-slate-800 border-slate-700 p-4 mb-6">
          ...
          <div className="flex items-center gap-2 mb-4">
            ...
            <span className="text-sm text-slate-400">Không giật, lag &gt;</span>
            <span className="text-sm text-blue-400">Nghe thử</span>
          </div>
          ...
          <div className="space-y-2">
            {chapters.map((chapter, index) => (
              <div
                key={index}
                className="flex items-center justify-between p-3 bg-slate-700 rounded hover:bg-slate-600 cursor-pointer"
              >
        ...
        <Card className="bg-slate-800 border-slate-700 p-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                <div className="text-sm text-slate-400">TRƯỚC ĐÓ</div>
                <div className="font-semibold">Trường Sinh Gia Tộc</div>
              </div>
            </div>
            <div className="flex items-center gap-3">
              <div>
                <div className="text-sm text-slate-400 text-right">TIẾP THEO</div>
      ...
      <footer className="bg-slate-800 border-t border-slate-700 py-6 mt-8">
        <div className="max-w-7xl mx-auto px-4 text-center">
          <p className="text-sm text-slate-400">Copyrights © 2025 truyenradio.com, All rights reserved.</p>
          <p className="text-sm text-slate-400">Liên hệ quảng cáo: example.contact@email.com</p>
        </div>
      </footer>
    </div>
  )
